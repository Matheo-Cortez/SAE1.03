/**
 * 
 * Gestion des arguments de lancement, démarrage du jeu
 * de lancement, démarrage du jeu
 */
...
# define TAILLE 10 /** sert a définir la taille du tableau */


# define MAX_BATEAU 20 /** brief sert a définir la taille du tableau */
////////////////////////
// Variables globales //
////////////////////////

static char *nom_prog;  /** Nom de l'exécutable */


int ligne = 10 ; /** Nombre de ligne */


int colonne = 10 ; /** Nombre de colonne */
...
type struct {
	...
	int colonne; /** Lorem ipsum2*/
	int ligne; /** Lorem ipsum3*/
} tCase1; /** contient les données d'une case vide */
...
type struct{
	...
	int colonne; /** Lorem ipsum2*/
	int ligne; /** Lorem ipsum3*/
} tCase2; /** contient les données d'une case pleine */
